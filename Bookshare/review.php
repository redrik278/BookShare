...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertQuery = "INSERT INTO Review (bookid, readerid, rating, comment) VALUES ('$bookid', '$readerid', '$rating', '$comment')";

    if ($conn->query($insertQuery) === TRUE) {
        echo "পর্যালোচনা সফলভাবে যোগ করা হয়েছে!";
    } else {
        echo "পর্যালোচনা যোগ করার সময় ত্রুটি: " . $conn->error;
    }
}
...
<body style="background-color: #000; color: #fff;" class="bd-dark text-white">
    ...
    <div class="container mt-4">
        <h2 class="book-details">পর্যালোচনা লিখুন <?php echo $bookDetails["title"]; ?> এর জন্য</h2>
        <div class="row ">
            ...
            <div class="col-md-8 book-details">
                ...
                <form method="post" action="review.php?bookid=<?php echo $bookid; ?>">
                    <label for="rating">রেটিং:</label>
                    <input type="number" class="form-control" id="rating" name="rating" min="1" max="5" required><br>
                    
                    <label for="comment">মন্তব্য করুন:</label>
                    <textarea class="form-control" id="comment" name="comment" required></textarea><br>
